...
#SBATCH --ntasks 7
#SBATCH --nodes=1
#SBATCH --output="/lustre/scratch/grp/fslg_internn/glom-pytorch/slurm/balanced/LinearRegDropOut.slurm"
#SBATCH --time 4:00:00
...
which python
python -u /lustre/scratch/grp/fslg_internn/glom-pytorch/MNIST_vgg.py --model LinearRegDropOut --data balanced