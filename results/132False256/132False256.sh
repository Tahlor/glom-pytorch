...
#SBATCH --ntasks 7
#SBATCH --nodes=1
#SBATCH --output="./results/132False256/log.slurm"
...
which python
python MNIST_train.py  --attention_radius 1 --iterations 3 --levels 2 --use_cnn False --glom_dim 256 --save_path ./results/132False256/model.pt
