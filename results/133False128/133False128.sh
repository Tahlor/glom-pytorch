...
#SBATCH --ntasks 7
#SBATCH --nodes=1
#SBATCH --output="./results/133False128/log.slurm"
...
which python
python MNIST_train.py  --attention_radius 1 --iterations 3 --levels 3 --use_cnn False --glom_dim 128 --save_path ./results/133False128/model.pt
