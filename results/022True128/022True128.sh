...
#SBATCH --ntasks 7
#SBATCH --nodes=1
#SBATCH --output="/lustre/scratch/grp/fslg_internn/glom-pytorch/./results/022True128/log.slurm"
...
which python
python MNIST_train.py  --attention_radius 0 --iterations 2 --levels 2 --use_cnn True --glom_dim 128 --save_path ./results/022True128/model.pt
