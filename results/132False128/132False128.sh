...
#SBATCH --ntasks 7
#SBATCH --nodes=1
#SBATCH --output="/lustre/scratch/grp/fslg_internn/glom-pytorch/./results/132False128/log.slurm"
...
which python
python MNIST_train.py  --attention_radius 1 --iterations 3 --levels 2 --use_cnn False --glom_dim 128 --save_path ./results/132False128/model.pt
